...
public class MainController
{
    ...
    private final B10aFileUploadApplication b10aFileUploadApplication;

    MainController(B10aFileUploadApplication b10aFileUploadApplication) {
        this.b10aFileUploadApplication = b10aFileUploadApplication;
    }
	@RequestMapping("/")
	public String home()
	{
	...
	public String uploadProcess(HttpServletRequest req, Model model) {
		try {
			...
			System.out.println("parHeader="+ partHeader);
			...
			String savdeFileName =
					MyFunctions.renameFile(uploadDir, originalFileName);
			
			model.addAttribute("originalFileName", originalFileName);
			model.addAttribute("savedFileName", savdeFileName);
